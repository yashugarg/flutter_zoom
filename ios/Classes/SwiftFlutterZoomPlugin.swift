...
public class SwiftFlutterZoomPlugin: NSObject, FlutterPlugin,FlutterStreamHandler , MobileRTCMeetingServiceDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let channel = FlutterMethodChannel(name: "com.yg/flutter_zoom", binaryMessenger: messenger)
    let instance = SwiftFlutterZoomPlugin()
    registrar.addMethodCallDelegate(instance, channel: channel)

    let eventChannel = FlutterEventChannel(name: "com.yg/flutter_zoom_event_stream", binaryMessenger: messenger)
