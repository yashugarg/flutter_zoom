...
public class FlutterZoomPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    methodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "com.yg/flutter_zoom");
    methodChannel.setMethodCallHandler(this);

    meetingStatusChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "com.yg/flutter_zoom_event_stream");
  }
  ...
  private void startMeeting(MethodCall methodCall, MethodChannel.Result result) {
    ...
    if(view_options){
      ...
      sendReply(Arrays.asList("MEETING SUCCESS", Integer.toString(resultMeetingStart)));
  }
...
/* 
  ...
  private void startMeetingNormalInternal(MethodCall methodCall) {
    ...
    // if(zoomSDK.isLoggedIn()) {
      ...
      inMeetingService = zoomSDK.getInMeetingService();
      sendReply(Arrays.asList("MEETING SUCCESS NORMAL", "200"));
    // }
  }
